...
//        $randomId = rand($minId, $maxId);
        ...
        $insertData = [
            ...
            'register_time' => time(),
            'login_ip' => $ip,
            'head_shot' => 'https://zksj-new.oss-cn-beijing.aliyuncs.com/bfyk/zk/image/ZKSJ_1770280030SR25.jpeg', //默认头像
...
//        $binaryData =  base64_decode($base64Image);
        ...
        foreach ($imageContent as  $value) {
            ...
            $file = 'https://'.$config['bucket'].'.'.$config['endpoint'].'/bfyk/zk/image/'.$fileName;
            $resp['file'][] = $file;
        }
